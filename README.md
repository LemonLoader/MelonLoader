...
- [Fadenfire](https://github.com/Fadenfire) - Implemented partial ARM64 support into MonoMod.
- [Atmudia](https://github.com/Atmudia/) - Did the initial port of the NativeAOT Bootstrap to Android.
